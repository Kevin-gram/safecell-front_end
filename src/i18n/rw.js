...
statistics: {
  title: "Imibare",
  subtitle: "Imyitwarire n’isesengura ry’ifatwa ry’indwara",
  detectionRate: "Igipimo cyo gutahura",
  timeRange: "Igihe cyatoranyijwe",
  today: "Uyu munsi",
  week: "Icyumweru",
  month: "Ukwezi",
  year: "Umwaka",
  custom: "Igihe wihitiyemo",
  positiveDetections: "Ibyabonetse ari indwara",
  negativeDetections: "Ibitari indwara",
  confidenceDistribution: "Ikigero cy’icyizere",
  noData: "Nta makuru aboneka ku gihe watoranyije",
  locationStats: "Imibare hashingiwe ku gace",
  province: "Intara",
  district: "Akarere",
  sector: "Umurenge",
  highRiskAreas: "Aho indwara igaragara cyane",
  casesPerRegion: "Ibyagaragaye mu Turere",
  intensityLevels: {
    title: "Urwego rw’ubukana",
    level1: "Urwego 1 - Rucye",
    level2: "Urwego 2 - Ruringaniye",
    level3: "Urwego 3 - Rurimo hagati",
    level4: "Urwego 4 - Rwinshi",
    level5: "Urwego 5 - Rukabije"
  },
  totalScans: "Ibipimo byose hamwe",
  positiveCases: "Ibyabonetse bifite indwara",
  negativeCases: "Ibidafite indwara",
  positiveRate: "Igipimo cy’abarwaye",
  exportData: "Ohereza amakuru hanze",
  distributionChart: "Imbonerahamwe y'ibyavuye mu isesengura"
}
,
  "time": {
    "morning": "Mwaramutse",
